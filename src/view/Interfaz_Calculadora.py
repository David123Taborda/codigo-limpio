import sys
sys.path.append("src")
from model.Calculadora import calcular_ingresos_total_anuales, calcular_deducciones_por_ley, deducciones_personales, calcular_renta_exenta, calcular_base_del_impuesto, ErrorValorNegativo, ErrorTipoDato
...
try:
    ...
    calcular_renta_exenta = calcular_renta_exenta(ingresos_totales, deducciones_por_ley)
    calcular_base_del_impuesto = calcular_base_del_impuesto(ingresos_totales, deducciones_por_ley, deducciones_personales, calcular_renta_exenta)

    print(f"Las salidas esperadas de acuerdo a los datos pedidos son: n/ Ingresos totales: {ingresos_totales} n/ Deducciones por ley: {deducciones_por_ley} n/ Deducciones personales: {deducciones_personales} n/ Renta exenta: {calcular_renta_exenta} n/ Base sobre la que se paga impuesto: {base_sobre_la_que_se_paga_impuesto}")
